...
<div id="loginStyle" style="background-color: white;width: 400px;margin-top: 5%" class="container">
    ...
    <h3 style="text-align: center;color: white;margin-top: 10%" class="titleIncress">Confirm payment</h3>
    ...
    <div style="margin-top: 5%" class="row align-items-start">
        ...
        <div  class="col">
            ...
            <form:form id="exec"  action="execute_payment" class="form-horizontal"   method="post">
                <input type="hidden" name="paymentId" id="paymentId" value="${param.paymentId}" />
                <input type="hidden" name="PayerID" id="PayerID" value="${param.PayerID}" />


                <div class="d-flex justify-content-center">
                    <button style="margin-top: 5%;margin-bottom:5%;width: 120px;height: 50px" type="submit"  class="btn btn-success btn-block">Pay Now</button>
                </div>
            </form:form>
