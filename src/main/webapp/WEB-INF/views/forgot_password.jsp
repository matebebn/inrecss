...
<c:if test="${key!=null}">
<c:forEach var="list" items="${listContact}" varStatus="status">

    <c:if test="${key==list.hash_code}">
        <c:set var = "idUser" scope = "session" value = "${list.id_user}"/>
        <c:set var = "expTime" scope = "session" value = "${list.expTime}"/>
    </c:if>
</c:forEach>
</c:if>
<jsp:useBean id="now" class="java.util.Date" />
<fmt:formatDate type = "both" dateStyle = "medium" var="curTime" timeStyle = "medium" value = "${now}"  pattern="yyyy-MM-dd HH:mm:ss" />


<c:if test="${key==null || curTime>expTime  && key!=null}">
    <div id="loginStyle" style="background-color: white;width: 400px;margin-top: 5%" class="container">
        ...
        <div style="margin-top: 5%" class="row align-items-start">
            ...
            <div  class="col">
                <c:if test="${curTime>expTime  && key!=null}">
                    <div id="divError" style="text-align: center;background-color: #d5dadd" class="alert alert-info col-xs-offset-1 col-xs-10">
                        <p style="color: white"> The Time To Reset Password Has Expired.<br>  Try Again</p>
                    </div>
                </c:if>
                <form:form id="resetPassword" action="getEmailFromDB" class="form-horizontal" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input style="height: 50px;margin-top: 10%" type="email" path="email" name="email" id="email" placeholder="Email" onkeypress="emptyActualPassword('email');" class="form-control"  >

                    </div>
                    <br>
                    <div class="d-flex justify-content-center">
                        <button style="margin-top: 5%;margin-bottom:5%;width: 200px;height: 50px" type="button" onclick="checkData();"  class="btn btn-success btn-block">Recover password</button>
                    </div>
                </form:form>
    ...
    <div id="loginStyle" style="background-color: white;width: 400px;margin-top: 5%" class="container">
        ...
        <div style="margin-top: 5%" class="row align-items-start">
            ...
            <div  class="col">
                ...
                <form:form id="updatePassword" action="updatePassword" class="form-horizontal" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input style="height: 50px;margin-top: 10%" type="password"  name="reset_password" id="reset_password" placeholder="Password" onkeypress="emptyActualPassword('reset_password');" class="form-control"  >

                    </div>
                    <div class="mb-3">

                        <input style="height: 50px;margin-top: 10%" type="password"  name="conPassword" id="conPassword" placeholder="Confirm password" onkeypress="emptyActualPassword('conPassword');" class="form-control"  >

                    </div>
                    <br>
                    <div class="d-flex justify-content-center">
                        <input  type="hidden"  name="idUserReset" id="idUserReset"  value="${idUser}"  class="form-control"  >
                        <input  type="hidden"  name="reset_token" id="reset_token"   value="${key}"  class="form-control"  >
                        <button style="margin-top: 5%;margin-bottom:5%;width: 200px;height: 50px" type="button" onclick="checkDataReset();"  class="btn btn-success btn-block">Reset password</button>
                    </div>
                </form:form>
...
var i=0;
function emptyActualPassword(name){
...
function checkDataReset() {
    ...
    {
        document.getElementById("conPassword").style.border="1px solid red";
        i=1;
    }
    if(document.getElementById('reset_password').value=="")
    {
        document.getElementById("reset_password").style.border="1px solid red";
        i=1;
    }
