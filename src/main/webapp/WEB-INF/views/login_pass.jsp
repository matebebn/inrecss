    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h2 class="h2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                        <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                    </svg>
                    Dashboard
            ...
            <h2 class="h2">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-calendar-check" viewBox="0 0 16 16">
                    <path d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                    <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/>
                </svg>
                Events
...
<c:forEach var="contact" items="${listContact}" varStatus="status">
                    ...
                    <tr>
                        ...
                        <td><button style="margin-top: 5%;margin-bottom:5%;"  type="submit"  class="btn btn-success btn-block">Page</button></td>
                         </form:form>
                    </tr>
    ...
    <script>
        ...
        var currentJanuary="${p0}";
        var currentFebruary="${p1}";
        var currentMarch="${p2}";
        var currentApril="${p3}";
        var currentMay="${p4}";
        var currentJune="${p5}";
        var currentJuly="${p6}";
        var currentAugust="${p7}";
        var currentSeptember="${p8}";
        var currentOctober="${p9}";
        var currentNovember="${p10}";
        var currentDecember="${p11}";

        var currentJanuaryEvent="${e0}";
        var currentFebruaryEvent="${e1}";
        var currentMarchEvent="${e2}";
        var currentAprilEvent="${e3}";
        var currentMayEvent="${e4}";
        var currentJuneEvent="${e5}";
        var currentJulyEvent="${e6}";
        var currentAugustEvent="${e7}";
        var currentSeptemberEvent="${e8}";
        var currentOctoberEvent="${e9}";
        var currentNovemberEvent="${e10}";
        var currentDecemberEvent="${e11}";

        var currentJanuaryMembers="${m0}";
        var currentFebruaryMembers="${m1}";
        var currentMarchMembers="${m2}";
        var currentAprilMembers="${m3}";
        var currentMayMembers="${m4}";
        var currentJuneMembers="${m5}";
        var currentJulyMembers="${m6}";
        var currentAugustMembers="${m7}";
        var currentSeptemberMembers="${m8}";
        var currentOctoberMembers="${m9}";
        var currentNovemberMembers="${m10}";
        var currentDecemberMembers="${m11}"
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        ...
                        currentJulyEvent,
                        currentAugustEvent,
                        currentSeptemberEvent,
                        currentOctoberEvent,
                        currentNovemberEvent,
                        currentDecemberEvent
                    ],
                }, {
                    label: 'Members',
                    fill: false,
                    ...
                    borderColor:   "#000000",
                    data: [
                        currentJanuaryMembers,
                        currentFebruaryMembers,
                        currentMarchMembers,
                        currentAprilMembers,
                        currentMayMembers,
                        currentJuneMembers,
                        currentJulyMembers,
                        currentAugustMembers,
                        currentSeptemberMembers,
                        currentOctoberMembers,
                        currentNovemberMembers,
                        currentDecemberMembers
