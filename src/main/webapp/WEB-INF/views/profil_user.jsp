...
<form:form id="editForm" modelAttribute="userEdit" action="editProfil"
           class="form-horizontal"   method="post">
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="" id="email" value="${email}" aria-describedby="emailHelp">

                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label">Phone number</label>
                    <input type="tel" class="form-control"  name="phone" placeholder="" value="${telefon}" id="phone">
                </div>
                <div class="mb-3">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h5 class="h5">
                        ...
                        <div class="row" >
                            <div class="col">
                                ...
                                <input type="password" oninput="checkNewPasswords()"  class="form-control"name="passwordNew" placeholder="" id="passwordNew">
                                <input type="hidden"  class="form-control" name="hiddenPassword" id="hiddenPassword" value="${password}">
                            </div>
                            <div class="col">
                                <label for="passwordConfirm" class="form-label">Confirm Password</label>
                                <input type="password"  oninput="checkNewPasswords()"  class="form-control" name="passwordConfirm" id="passwordConfirm">
                            </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" v-on:input="emptyActualPassword('actualPassword');"  class="form-control"  id="actualPassword" name="actualPassword" aria-describedby="actualPassword">
                    ...
                    <div class="row">
                        <div    style="background-color: #e5e5e5;height: 50px; display: flex;align-items: center;margin-top: 20px;border-radius: 10px" class="col">
                            <input type="hidden" name="id_edit" placeholder="" value="${id_user}" class="form-control"/>
                            <button  type="button"  @click="changeData();" class="btn btn-success">Approve</button>
                            <a href="login_pass" style="margin-left: 10px" type="submit" class="btn btn-light">Cancel</a>
                        </div>
...
<script type="text/babel">
    function checkNewPasswords() {
        document.getElementById("passwordNew").style.border = "";
    ...
    new Vue ({
        ...
        let newPasswordConfirm = document.getElementById("passwordConfirm").value;
        ...
        if(newPassword != "" && newPasswordConfirm =="" || newPassword == "" && newPasswordConfirm !="" || newPassword.length!=newPasswordConfirm.length  ){
            document.getElementById("passwordNew").style.border = "1px solid red";
            document.getElementById("passwordConfirm").style.border = "1px solid red";
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Password dont match or empty',
                backdrop: `rgba(56, 50, 50, 0.8)`,
            })
            changePassword=1;
        }else {
            changePassword=0;
                 ...
                 if(actualPassword != "" && changePassword==0){document.getElementById("editForm").submit();}
