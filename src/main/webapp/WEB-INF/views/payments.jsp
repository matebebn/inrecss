                ...
                <table id="example1" class="table table-striped table-sm">
                    ...
                    <c:forEach var="member" items="${memberList}" varStatus="xd">
                        ...
                        <tr>
                            ...
                            <form:form id="event_page" action="getEventPayments" class="form-horizontal"   method="get">
                                <c:if test="${member.id_person == pay.id_person}">
                                ...
                                <td style="  vertical-align: middle;"> <c:if test="${pay.invoice==1}">Yes</c:if><c:if test="${pay.invoice==0}">No</c:if></td>
                                ...
                                <td>
                                    <button style="margin-top: 5%;margin-bottom:5%;"  type="button"  onclick="editStatus('${member.name}','${member.surname}','${member.email}','${pay.status_payment}','${pay.id_payment}','${pay.id_person}','${pay.id_event}')"  class="btn btn-primary btn-block">Change status</button>
                    ...
                    <c:forEach var="contact" items="${listContact}" varStatus="status">
                        ...
                        <tr>
                            <form:form id="event_page" action="getEventPayments" class="form-horizontal"   method="get">
                                ...
                                <td><button style="margin-top: 5%;margin-bottom:5%;"  type="submit"   class="btn btn-success btn-block">Show payments</button></td>
                            </form:form>
                        </tr>
...
<script type="text/babel">
    ...
    function  changeBG(){
        ...
        if(selectedValue==1)
        {
            selectBox.style.background="#198754";
        }
        else
        {
            selectBox.style.background="#ffc107";
        }
    };

        function  editStatus(username,surname,email,status,id,idPerson,idEvent){
        Swal.fire({
            html: `<form:form id="updateStatus"  action="updateStatus" class="form-horizontal"   method="POST">
            <h4>Name</h4>
  <input type="text" id="username" class="swal2-input" name="username" placeholder="" value="" readonly>
   <h4>Surname</h4>
 <input type="text" id="surname" name="surname" class="swal2-input" placeholder="" readonly>
  <h4>Email</h4>
 <input type="text" id="email" name="email" class="swal2-input" placeholder="" readonly>
  <h4>Status</h4>
  <input type="hidden"  id="getIdEvent" name="getIdEvent" placeholder=""  class="class="swal2-input"/>
  <input type="hidden"  id="idUpdateStatus" name="idUpdateStatus" placeholder=""  class="class="swal2-input"/>
    <input type="hidden"  id="idPerson" name="idPerson" placeholder=""  class="class="swal2-input"/>
<select onchange="changeBG();"  name="status" id="status" class="form-select">
 ...
 <button style="width:150px;height:50px;margin-top:50px;"  type="submit"  class="btn btn-success btn-block">Update</button></form:form>`,
            ...
            document.getElementById("getIdEvent").value=idEvent;
        document.getElementById("idUpdateStatus").value=id;
        ...
        if(status==1)
        {
            ...
            $("#result").on("change", "select[name='status']", function(){
